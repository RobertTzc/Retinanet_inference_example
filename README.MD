...
quick example:
```
python inference_image_list.py --model_dir ./checkpoint/Bird_A/final_model.pkl --model_type Bird_A --image_root ./example_images/Bird_A  --evaluate true --image_ext JPG --visualize true --out_dir ./Result/Bird_A
```
