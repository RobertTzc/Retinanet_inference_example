...
--image_root ./example_images/Bird_drone \
--image_ext jpg \
--image_altitude 15 \
--use_altitude true \
--image_date 2022-11-01 \
--image_location University_of_Missouri \
--out_dir ./Result/Bird_drone \
--evaluate true \
--visualize true 
```
