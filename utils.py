...
def filter_slice(bbox,coor,image_width,mega_image_shape,dis = 5):
    """
    ...
    boundary = [[coor[0],coor[1]],[coor[0]+image_width,coor[1]+image_width]]
    thresh = [[0,0],[image_width,image_width]]
    if (boundary[0][0]==0):
        thresh[0][0]-=100
    if (boundary[0][1]==0):
        thresh[0][1]-=100
    if (boundary[1][0]==mega_image_shape[1]):
        thresh[1][0]+=100
    if (boundary[1][1]==mega_image_shape[0]):
        thresh[1][1]+=100
    for box in bbox:
